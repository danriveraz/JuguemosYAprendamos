        ...
        <section class="wrapper">
          <form  id="formPalabras"  method="GET"  action="{{route('paciente.createstics', ['id' => $idPaciente, 'level' => $level])}}">
            ...
            <div id="img1" class="text-center" style="display: block;" >
              <a>
                <img src="{{$palabras[0]['ruta']}}" alt="Imagen {{$palabras[0]['palabra']}}" width="300" height="300" style="border: 2px solid;">
              </a>
              <h3 class="text-center">{{$palabras[0]["palabra"]}}</h3>
            </div>
            <div id="img2" class="text-center" style="display: none;" >
              <a>
                <img src="{{$palabras[1]['ruta']}}" alt="Imagen {{$palabras[1]['palabra']}}" width="300" height="300" style="border: 2px solid;">
              </a>
              <h3 class="text-center">{{$palabras[1]["palabra"]}}</h3>
            </div>
            <div id="img3" class="text-center" style="display: none;" >
              <a>
                <img src="{{$palabras[2]['ruta']}}" alt="Imagen {{$palabras[2]['palabra']}}" width="300" height="300" style="border: 2px solid;">
              </a>
              <h3 class="text-center">{{$palabras[2]["palabra"]}}</h3>
            </div>
            <div id="img4" class="text-center" style="display: none;" >
              <a>
                <img src="{{$palabras[3]['ruta']}}" alt="Imagen {{$palabras[3]['palabra']}}" width="300" height="300" style="border: 2px solid;">
              </a>
              <h3 class="text-center">{{$palabras[3]["palabra"]}}</h3>
            </div>
            <div id="img5" class="text-center" style="display: none;" >
              <a>
                <img src="{{$palabras[4]['ruta']}}" alt="Imagen {{$palabras[4]['palabra']}}" width="300" height="300" style="border: 2px solid;">
              </a>
              <h3 class="text-center">{{$palabras[4]["palabra"]}}</h3>
            </div>
            <div id="img6" class="text-center" style="display: none;" >
              <a>
                <img src="{{$palabras[5]['ruta']}}" alt="Imagen {{$palabras[5]['palabra']}}" width="300" height="300" style="border: 2px solid;">
              </a>
              <h3 class="text-center">{{$palabras[5]["palabra"]}}</h3>
            </div>
            <br>
            ...
            <div class="text-center" >
              ...
              <audio id="audio0">
                <source id="sonido" src="{{$palabras[0]['audio']}}" type="audio/ogg">
              </audio>
              <audio id="audio1">
                <source id="sonido" src="{{$palabras[1]['audio']}}" type="audio/ogg">
              </audio>
              <audio id="audio2">
                <source id="sonido" src="{{$palabras[2]['audio']}}" type="audio/ogg">
              </audio>
              <audio id="audio3">
                <source id="sonido" src="{{$palabras[3]['audio']}}" type="audio/ogg">
              </audio>
              <audio id="audio4">
                <source id="sonido" src="{{$palabras[4]['audio']}}" type="audio/ogg">
              </audio>
              <audio id="audio5">
                <source id="sonido" src="{{$palabras[5]['audio']}}" type="audio/ogg">
              </audio>
